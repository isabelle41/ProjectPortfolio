...
bool YoloInterface::captureAndDetect(CameraSource camera, bool save_image) {
    ...
    // ADDED - SET CAMERA SOURCE SO THAT WE CAN ACCESS IT IN YOLO_DETECTOR.PY (GIVEN PERMISSION TO CHANGE THIS BY SOUREN //
    if (camera == CameraSource::OAKD) {
        detect_request->camera_source = "oakd";
    } else {
        detect_request->camera_source = "wrist";
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
